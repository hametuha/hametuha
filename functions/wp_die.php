 ...
 * @return string
 */
function _hametuha_wp_die_handler($function){
     //get_bloginfoが使えれば使う。
     //なければデフォルトのwp_dieを使う
     if(function_exists("get_bloginfo") && "" != get_bloginfo("template_directory") && !is_admin()){
          return "_hametuha_wp_die";
     }else{
          return $function;
     }
}
add_filter("wp_die_handler", "_hametuha_wp_die_handler", 1000);
