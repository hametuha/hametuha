...
function help_tip( $string, $place = null ) {
	printf(
		'<a href="#" class="btn btn-xs btn-default help-tip" data-toggle="tooltip" data-original-title="%s"%s><i class="icon-question5"></i></a>',
		esc_attr( $string ),
		( $place ? 'data-placement="' . esc_attr( $place ) . '"' : '' )
	);
}
...
add_filter(
	...
	function ( $markup, $messages, $class_name ) {
