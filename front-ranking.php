		...
		<div class="col-xs-12 col-sm-9 main-container">
			...
			<?php
				...
				if ( $latest_day->have_posts() ) :
					?>
				<h2><i class="icon-new"></i> <?php echo date_i18n( 'Y年n月j日（D）', $latest_date ); ?>のランキング</h2>
				<ol class="archive-container media-list">
					<?php
				...
				<p>
					<a class="btn btn-default btn-lg btn-block" href="<?php echo home_url( '/ranking' . date_i18n( '/Y/m/d/', $latest_date ) ); ?>">
			...
			<?php
				...
				if ( $latest_month->have_posts() ) :
					?>
				<h2><i class="icon-calendar5"></i> <?php echo date_i18n( 'Y年n月', $this_month ); ?>のランキング</h2>
				<ol class="archive-container media-list">
					<?php
				...
				<p>
					<a class="btn btn-default btn-lg btn-block" href="<?php echo home_url( '/ranking' . date_i18n( '/Y/m/', $this_month ) ); ?>">
			...
			<?php
				...
				<p>
					<a class="btn btn-default btn-lg btn-block" href="<?php echo home_url( '/best/' ); ?>">
						歴代ランキングを見る
					</a>
				</p>
