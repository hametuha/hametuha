 ...
 * Single page helper
 *
 * @handle hametuha-single
 * @deps hametuha-common, chart-js, jquery-form, jquery-touch-punch, jquery-ui-slider
 */
...
Hametuha.views.Scroll = Backbone.View.extend( {
	...
	moveTo: function ( percent ) {
		const position = ( $( document ).height() - $( window ).height() ) * percent;
		this.animating = true;
...
jQuery( document ).ready( function ( $ ) {
	...
	// ナビゲーション
	const defaultView = 'viewing-content';
	const $article = $( '#viewing-content' );
	const $nav = $( '#footer-single' );
