 ...
 */
add_filter(
	'hashboard_page_description',
	function ( $desc, \Hametuha\Hashboard\Pattern\Screen $screen, $page ) {
...
add_action(
	...
	function ( \Hametuha\Hashboard\Pattern\Screen $page, $child ) {
		if ( 'sales' !== $page->slug() ) {
			return;
		}
