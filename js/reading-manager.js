...
var hametuhaReadingManager = {
	...
	setupPagenation: function(){
		this.curPage = 1;
		this.width = jQuery('#reading-container .post-content').width();
		this.pageWidth = jQuery('#reading-container .inner').width();
		this.totalPage = jQuery('#reading-container .post-content').width() / this.pageWidth;
	},
	
	movePos: function (page){
		page = Math.max(1, page);
		jQuery('#reading-container .inner').scrollLeft(this.width - (page - 1) * this.pageWidth);
		this.curPage = page;
	},
	...
	touchEnd: function(e){
		jQuery('#reading-container .inner').unbind('touchmove', hametuhaReadingManager.touchMove);
		moved = hametuhaReadingManager.latestX - hametuhaReadingManager.startX;
