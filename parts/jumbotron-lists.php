...
?>
<div class="jumbotron" id="thread-tron" style="background-image: url('<?= $image ?>');" title="Pieter Brueghel the Elder (1526/1530–1569) [Public domain or Public domain], via Wikimedia Commons">
    <h1>みんなで作る作品リスト</h1>
