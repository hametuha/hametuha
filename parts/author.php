...
<div class="author-profile row" itemscope itemprop="author" itemtype="http://schema.org/Person">
	...
	<div class="col-sm-9 col-xs-12">
		...
		?>
		<div class="author-desc<?php echo $too_long ? ' author-desc--long' : ''; ?>">
			<?php echo wpautop( esc_html( $desc ) ); ?>
		</div>
		<ul class="list-inline">
			<li>
				<i class="icon-calendar"></i> <?php echo hametuha_passed_time( get_the_author_meta( 'user_registered' ) ); ?>登録
			</li>
			<li>
				<i class="icon-quill3"></i> <?php echo number_format( get_author_work_count() ); ?>作品
			</li>
		</ul>
		...
		<div class="author-profile__actions">
			...
			<?php if ( hametuha_user_allow_contact( get_the_author_meta( 'ID' ) ) ) : ?>
				<a class="btn btn-success" href="<?php echo hametuha_user_contact_url(); ?>">
					問い合わせ
				</a>
			<?php endif; ?>
		</div>
