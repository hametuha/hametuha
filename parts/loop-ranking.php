		...
		<div class="media-body">
			...
			<h2>
				...
				<?php if ( current_user_can( 'edit_others_posts' ) ) : ?>
					<span class="label label-default"><?php echo number_format( $post->pv ); ?>PV</span>
				<?php endif; ?>
			</h2>
...
endswitch;
				...
				<li class="static"><i class="icon-reading"></i> <?php echo number_format( get_post_length() ); ?>文字</li>
			</ul>
