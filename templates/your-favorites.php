	...
	<?php author_pagination($total); ?>
		<?php if(!empty($favorites)): ?>
			<ol class="commentlist favoritelist">
				<?php foreach($favorites as $fav):$original_post = get_post($fav->post_id); ?>
					<li id="li-fav-<?php echo $fav->ID; ?>">
						<div id="fav-<?php echo $fav->ID; ; ?>" class="comment">
							<div class="comment-meta clearfix">
								<div class="comment-author vcard">
									...
									<span class="edit-link right">
										<a class="delete-fav small-button comment-edit-link" rel="nofollow" id="delete_fav_<?php echo $fav->ID; ; ?>" href="#">削除する</a>
