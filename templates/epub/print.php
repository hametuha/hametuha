...
<div class="print-wrapper container">
	...
	<footer class="print-footer row">
		<div class="col-xs-6 print-total">
			<strong><?php echo number_format( $total_length / 400, 1 ); ?>枚</strong>
			<small>（<?php echo number_format( $total_length ); ?>文字）</small>
		</div>
		<div class="col-xs-6 text-right">
			計<?php echo number_format_i18n( $query->post_count ); ?>作品
			<small>（平均<?php echo number_format_i18n( $total_length / $query->post_count, 1 ); ?>文字）</small>
		</div>
	</footer>
</div>
<?php wp_footer(); ?>
