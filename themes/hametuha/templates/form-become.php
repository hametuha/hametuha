<?php get_header( 'login' ); ?>
	...
	<div id="login-body">
		...
		<div class="alert alert-info">
			<p>
				こんにちは、<strong><?php echo esc_html( $name ); ?></strong>さん。あなたは同人になろうとしています。<br />
		...
		<form id="become-author-form" method="post" action="<?php echo $action; ?>">
			...
			<div class="form-group">
				...
				<ul class="notice-list">
					...
					<li>同人はプロフィール、名前などが公開されます。筆名などがそのままでもよいかどうか、<a href="<?php echo admin_url( 'profile.php' ); ?>">プロフィール編集</a>で検討してから同人になってください。</li>
