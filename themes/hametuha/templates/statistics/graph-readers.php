...
<div class="row">
	...
	<div id="analytics-users" class="stat col-xs-12 col-sm-6" data-type="PieChart" data-endpoint="<?php echo $endpoint['users']; ?>">
	...
	<div id="analytics-region" class="stat col-xs-12 col-sm-6" data-type="GeoChart" data-endpoint="<?php echo $endpoint['region']; ?>">
