				...
				<article itemscope
						...
						<ul class="ideas__list">
							...
							<li class="ideas__item ideas__item--author">
								...
								if ( ! $post->idea_author && user_can( $post->post_author, 'edit_posts' ) ) :
									?>
									<a itemprop="author" href="<?php echo $author_url; ?>"><?php echo $author_name; ?></a>
								<?php else : ?>
							...
							<li class="ideas__item ideas__item--comment">
								...
								<li class="ideas__item ideas__item--edit">
									<a class="btn btn-xs btn-primary" href="<?php echo home_url( "/my/ideas/edit/{$post->ID}/" ); ?>" data-action="edit-idea">
										編集
									</a>
								</li>
								<li class="ideas__item ideas__item--edit">
							...
							<li class="ideas__item ideas__item--status">
								...
								<span class="label label-<?php echo $class_name; ?>"><?php echo esc_html( get_post_status_object( get_post_status() )->label ); ?></span>
							</li>
						</ul>
					</div><!-- //.post-meta -->
					...
					<div class="ideas__body" itemprop="articleBody">
							...
							<div class="ideas__body--hide">
								<div class="alert alert-danger text-center">
									...
									<a class="alert-link" href="<?php echo wp_login_url( get_permalink() ); ?>">ログイン</a>
									が必要です。<br />
									ケチですいません……
								</div>
							</div>
					...
					<div class="ideas__actions">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-xs-12">
								<a class="btn btn-info btn-block" rel="nofollow" href="<?php echo home_url( '/my/ideas/recommend/' . get_the_ID() . '/' ); ?>" data-recommend="<?php the_ID(); ?>">他の人に薦める</a>
							</div>

							<div class="col-sm-4 col-xs-12">
								<a class="btn btn-success btn-block" rel="nofollow" href="<?php echo home_url( '/my/ideas/new/' ); ?>" data-action="post-idea">もっといいアイデア</a>
							</div>

						<?php else : ?>
							<div class="col-xs-12">
								<a href="<?php echo wp_login_url( get_permalink() ); ?>" class="btn btn-block btn-primary">ログインしてストックしたり勧めたりする</a>
							</div>
						<?php endif; ?>
						</div>
					</div>
					<div class="ideas__statistic">
										...
										if ( $total ) :
											?>
							<p class="text-center text-muted"><?php echo number_format( $total ); ?>人がストックしています。</p>
